...
async function initMap() {
    ...
    if (fakeProfileBtn) {
        fakeProfileBtn.addEventListener('click', () => alert("Funcionalidade de perfil (demo sem backend)"));
    }

    if (fakeLogoutBtn) {
        fakeLogoutBtn.addEventListener('click', () => alert("Logout simulado. Recarregue a página."));
    }
